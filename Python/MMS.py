...
def navigate_maze():
    ...
    while not at_center():
        ...
        if (
            micromouse_y + 1 <= 15
            and micromouse_x + 1 <= 15
            and micromouse_x - 1 >= 0
            and micromouse_y - 1 >= 0
        ):
            if (
                cell.value > maze[micromouse_x][micromouse_y + 1].value
                and cell.n == False
            ):
                if MO == MAZE_NORTH:
                    move_forward()
                ...
                cell.value > maze[micromouse_x + 1][micromouse_y].value
                and cell.e == False
            ):
                if MO == MAZE_NORTH:
                    move_right()
